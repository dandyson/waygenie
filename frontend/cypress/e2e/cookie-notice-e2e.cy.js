describe("Cookie Notice", () => {
  ...
  it("displays the cookie notice with correct text", () => {
    cy.contains("This site uses essential cookies for authentication").should("be.visible");
    cy.contains("By using this app, you agree to our use of cookies").should("be.visible");
  });
  ...
  it("has a working privacy policy link", () => {
    ...
    cy.contains("WayGenie is a demo portfolio application").should("be.visible");
