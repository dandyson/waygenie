...
describe('InterestsInput component', () => {
  ...
  describe('initial rendering', () => {
    beforeEach(() => {
      render(<InterestsInput nextStep={mockNextStep} backStep={mockBackStep} formData={formData} />);
    });

    test('renders with default empty interest', () => {
      const initialInterestInput = screen.getByPlaceholderText('Enter Interest...');
  ...
  describe('adding new interests', () => {
    ...
    test('renders new interest input', () => {
      const newInterestInput = screen.getAllByPlaceholderText('Enter Interest...')[1];
  ...
  describe('removing interests', () => {
    test('removes input element when remove button is clicked', async () => {
      ...
      const initialInterestInputs = screen.getAllByPlaceholderText('Enter Interest...');
      ...
      const interestInputs = screen.getAllByPlaceholderText('Enter Interest...');
  ...
  describe('submitting the form', () => {
    beforeEach(() => {
      render(<InterestsInput nextStep={mockNextStep} backStep={mockBackStep} formData={formData} />);
      const remainingInterestInputs = screen.getAllByPlaceholderText('Enter Interest...');
      fireEvent.change(remainingInterestInputs[0], { target: { value: 'Parks' } });
    });
